...
@section('content')
    <style>
        ...
        #chat-loading-spinner.active {
            display: flex !important;
        }

        #chat-box.chat-loading-hidden {
            opacity: 0;
            pointer-events: none;
        }
    ...
    <div class="content main_content">
        ...
        <div id="spa-page-content">
                ...
                <div>
                    <div class="chat-header">
                        <div class="user-details">
                            ...
                            <div id="chat-header-avatar" class="avatar avatar-lg flex-shrink-0" role="img" aria-label="">
                            </div>
                            ...
                            <ul>
                                ...
                                <li>
                                    <a class="btn no-bg" href="javascript:void(0);" data-bs-toggle="dropdown"
                                        aria-expanded="false" aria-label="{{ __('More options') }}">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end chat-header-more-dropdown py-2">
                                        ...
                                        <li><a href="javascript:void(0);" class="dropdown-item text-danger"
                                                data-bs-toggle="modal" data-bs-target="#delete-user-chat"><i
                                        ...
                                        <li><a href="javascript:void(0);" class="dropdown-item" data-bs-toggle="modal"
                                                data-bs-target="#block-user" id="blockUserDropdownBtn"><i
                                                    class="ti ti-ban me-2"></i><span
                                                    id="chat-header-block-menu-label">{{ __('Block') }}</span></a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
            ...
            <div class="chat-offcanvas offcanvas offcanvas-end contact-profile-offcanvas" data-bs-scroll="true"
                data-bs-backdrop="false" tabindex="-1" id="contact-profile" aria-labelledby="chatUserMoreLabel">
                        ...
                        <div class="profile-content px-3 pb-3">
                            ...
                            <div class="contact-profile-info text-center pt-2">
                                <div id="contact-avatar"
                                    class="avatar avatar-xxl online mb-3 mx-auto contact-panel-avatar-wrap"></div>
                            ...
                            <div class="contact-action-grid mb-4">
                                <a href="javascript:void(0);" class="contact-action-tile" id="contact-profile-audio-btn"
                                    title="{{ __('Audio') }}">
                                    <i class="ti ti-phone"></i>
                                    <span>{{ __('Audio') }}</span>
                                </a>
                                <a href="javascript:void(0);" class="contact-action-tile" id="contact-profile-video-btn"
                                    title="{{ __('Video') }}">
                                    <i class="ti ti-video"></i>
                                    <span>{{ __('Video') }}</span>
                                </a>
                                <a href="javascript:void(0);" class="contact-action-tile" id="contact-profile-chat-btn"
                                    title="{{ __('Chat') }}">
                                    <i class="ti ti-message"></i>
                                    <span>{{ __('Chat') }}</span>
                                </a>
                                <a href="javascript:void(0);" class="contact-action-tile" id="contact-profile-search-btn"
                                    title="{{ __('Search') }}">
                                    <i class="ti ti-search"></i>
                                    <span>{{ __('Search') }}</span>
                                </a>
                                        ...
                                        <ul class="list-group list-group-flush profile-item contact-profile-rows">
                                            <li class="list-group-item border-0 px-0 py-3">
                                                <div class="profile-info flex-grow-1 pe-2">
                                                    ...
                                                    <p class="contact-field-value mb-0 d-flex align-items-center flex-wrap gap-1"
                                                        id="contact-name">
                                            ...
                                            <li class="list-group-item border-0 px-0 py-3">
                                                ...
                                                <div class="profile-icon text-muted"><i class="ti ti-calendar-event"></i>
                                                </div>
                                            </li>
                                            <li class="list-group-item border-0 px-0 py-3">
                                                <div class="profile-info flex-grow-1 pe-2">
                                ...
                                <div class="card contact-info-card border-0">
                                    <div class="card-body list-group list-group-flush profile-item p-0">
                                        ...
                                        <a href="javascript:void(0);"
                                            class="list-group-item list-group-item-action border-0 px-0 py-3 d-flex align-items-center justify-content-between contact-media-row"
                                            id="contact-media-photos" data-media-target="media-collapse-photos">
                                        ...
                                        <a href="javascript:void(0);"
                                            class="list-group-item list-group-item-action border-0 px-0 py-3 d-flex align-items-center justify-content-between contact-media-row"
                                            id="contact-media-videos" data-media-target="media-collapse-videos">
                                            <div class="d-flex align-items-center gap-2"><i
                                        ...
                                        <a href="javascript:void(0);"
                                            class="list-group-item list-group-item-action border-0 px-0 py-3 d-flex align-items-center justify-content-between contact-media-row"
                                            id="contact-media-links" data-media-target="media-collapse-links">
                                            <div class="d-flex align-items-center gap-2"><i
                                        ...
                                        <a href="javascript:void(0);"
                                            class="list-group-item list-group-item-action border-0 px-0 py-3 d-flex align-items-center justify-content-between contact-media-row"
                                            id="contact-media-docs" data-media-target="media-collapse-docs">
                                            <div class="d-flex align-items-center gap-2"><i
                            ...
                            <div id="common-groups-container" class="content-wrapper other-info mb-3">
                                ...
                                <div class="text-center mt-2 mb-1">
                                    <a href="{{ route('group-chat') }}"
                                        class="small fw-medium contact-more-groups-link">{{ __('More Groups') }} →</a>
                                </div>
                            </div>
                            ...
                            <div class="content-wrapper other-info mb-0">
                                ...
                                <div class="card contact-info-card border-0 mb-0">
                                    <div class="card-body list-group profile-item p-0">
                                        ...
                                        {{-- Favorites --}}
                                        <a href="javascript:void(0);"
                                            class="list-group-item list-group-item-action border-0 px-0 py-3 d-flex align-items-center justify-content-between others-accordion-row"
                                            id="contact-open-favourites">
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <span class="badge bg-danger rounded-pill ms-1 d-none"
                                                    id="contact-favourites-badge">0</span>
                                            </div>
                                            <span class="link-icon others-chevron"><i
                                        ...
                                        <div class="collapse others-collapse-content" id="others-collapse-favourites">
                                            <div class="pb-2">
                                                ...
                                                <div class="others-empty text-muted small text-center py-2 d-none">
                                                    {{ __('No saved messages for this chat.') }}</div>
                                            ...
                                            <div class="pb-3 pt-1">
                                                @foreach(['30 Minutes', '1 Hour', '1 Day', '1 Week', '1 Month', '1 Year', 'Always'] as $i => $label)
                                                    <div class="form-check mb-2">
                                                        <input class="form-check-input" type="radio" name="others_mute"
                                                            id="others-mute-{{ $i }}">
                                                        <label class="form-check-label small"
                                                            for="others-mute-{{ $i }}">{{ __($label) }}</label>
                                                    </div>
                                                @endforeach
                                                <div class="d-flex gap-2 mt-2">
                                                    <button type="button"
                                                        class="btn btn-outline-secondary btn-sm flex-fill others-collapse-cancel">{{ __('Cancel') }}</button>
                                                    <button type="button" class="btn btn-primary btn-sm flex-fill"
                                                        id="others-mute-confirm-btn">{{ __('Mute') }}</button>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="collapse others-collapse-content" id="others-collapse-block">
                                            <div class="pb-3 pt-1 text-center">
                                                <p class="text-muted small mb-3" id="others-block-desc">
                                                ...
                                                <div class="d-flex gap-2">
                                                    <button type="button"
                                                        class="btn btn-outline-secondary btn-sm flex-fill others-collapse-cancel">{{ __('Cancel') }}</button>
                                                    <button type="button" class="btn btn-primary btn-sm flex-fill"
                                                        id="others-block-confirm-btn">{{ __('Block') }}</button>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="pb-3 pt-1">
                                                ...
                                                <div class="form-check mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="others-report-check">
                                                    <label class="form-check-label small"
                                                        for="others-report-check">{{ __('Report User') }}</label>
                                                </div>
                                                <div class="d-flex gap-2">
                                                    <button type="button"
                                                        class="btn btn-outline-secondary btn-sm flex-fill others-collapse-cancel">{{ __('Cancel') }}</button>
                                                    <button type="button" class="btn btn-primary btn-sm flex-fill"
                                                        id="others-report-confirm-btn">{{ __('Report') }}</button>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="pb-3 pt-1 text-center">
                                                ...
                                                <div class="d-flex gap-2">
                                                    ...
                                                    <button type="button" class="btn btn-danger btn-sm flex-fill"
                                                        id="others-delete-confirm-btn">{{ __('Delete') }}</button>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ route('chat') }}" method="get">
                                ...
                                <div class="mb-3">
                                    <div class="form-check mb-3">
                                        <input class="form-check-input" type="radio" name="disappear_duration"
                                            id="dm-chat-24h">
            ...
            <!-- Contact Detail (dynamic fields; simple header on /chat — no edit/delete modals in this view) -->
                            ...
                            <div class="card bg-transparent-dark flex-fill border mb-3">
                                <div class="card-body d-flex justify-content-between p-3">
                                    <div class="row justify-content-between flex-fill row-gap-3">
                                        <div class="col-lg-5">
                                            <div
                                                class="d-flex justify-content-between align-items-center flex-wrap row-gap-2">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <div class="row justify-content-center">
                                                    <div class="layout-tab d-flex justify-content-center ">
                                                        <div class="nav nav-pills inner-tab " id="pills-tab2"
                                                            role="tablist">
                                            ...
                                            <div class="d-flex align-items-end justify-content-end">
                                                <span
                                                    ...
                                                    <span class="avatar avatar-xxl bg-soft-primary rounded-circle p-2">
                                                        <span
                                                            class="d-inline-flex align-items-center justify-content-center rounded-circle w-100 h-100 avatar-contact-fallback"><i
                                                                class="ti ti-user" aria-hidden="true"></i></span>
                                                    </span>
                                                </span>
                                            </div>
                                        </div>
        ...
        <div id="spa-page-modals">
            {{-- Group video modals (#video_group_new, #video-call-new-group): single copy in frontend.partials.popups --}}
            ...
            {{-- Audio call modals (voice-attend-new, audio-call-modal) are in frontend.partials.popups so they exist on all
            pages for incoming calls --}}
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body pt-2">
                            <input type="search" id="forward-contact-search" class="form-control form-control-sm mb-2"
                                placeholder="{{ __('Search contacts…') }}" autocomplete="off" aria-label="{{ __('Search contacts') }}"
                                style="display: none;">
                            <div class="forward-contact-scroll rounded border bg-light bg-opacity-50 p-2"
                                style="max-height: min(52vh, 400px); overflow-y: auto;">
                                <div class="user-list forward-contact-picker d-flex flex-column gap-1">
