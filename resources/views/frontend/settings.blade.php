                    ...
                    <div class="card-body pb-1">
                        <div class="mb-2">
                            <div class="row align-items-center">
                                ...
                                <div class="col-sm-6">
                                    <p class="mb-2 d-flex align-items-center"><i class="ti ti-brand-linkedin me-1"></i>Linkedin <i class="linkedin-info-icon" data-bs-toggle="tooltip" data-bs-placement="top" title="LinkedIn does not allow OAuth to verify profile">i</i></p>
                                </div>
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    <p class="mb-2 d-flex align-items-center"><i class="ti ti-device-gamepad-2 me-1"></i>Kick</p>
                                </div>
                                <div class="col-sm-6">
                                    <h6 class="fw-medium fs-14 mb-2" data-field="kick"></h6>
                                </div>
                                <div class="col-sm-6">
                                    <p class="mb-2 d-flex align-items-center"><i class="ti ti-brand-twitch me-1"></i>Twitch</p>
                                </div>
                                <div class="col-sm-6">
