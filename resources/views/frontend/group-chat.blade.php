...
@php
    try {
        $callsProvider = config('calls.provider', 'meet');
    } catch (\Throwable $e) {
        $callsProvider = 'meet';
    }
@endphp
...
@section('content')
    ...
    <div class="content main_content">
        ...
        <div id="spa-page-content">
            ...
            <div class="chat chat-messages show" id="middle" style="display: none;">
                <div>
                    <div class="chat-header">
                        ...
                        <div class="d-flex align-items-center gap-2" id="header-member-avatars-wrap"
                            ...
                            <ul>
                                ...
                                @if($callsProvider === 'meet')
                                    <li data-bs-toggle="tooltip" data-bs-placement="bottom" title="Start Google Meet">
                                        <a href="https://meet.google.com/new" target="_blank" class="btn"
                                            id="google-meet-btn-group">
                                            <img src="{{ asset('assets/img/icons/google-meet.svg') }}" alt="Google Meet"
                                                class="google-meet-icon">
                                        </a>
                                    </li>
                                @endif
                                ...
                                <li title="Group Info" data-bs-toggle="tooltip" data-bs-placement="bottom">
                                    <a href="javascript:void(0)" class="btn" data-bs-toggle="offcanvas"
                                        data-bs-target="#contact-profile" id="groupcontactInfoButton">
                                ...
                                <li>
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end p-3">
                                        <li><a href="#" class="dropdown-item" id="close-group-btn"><i
                                                    class="ti ti-x me-2"></i>{{ __('Close Group')}}</a></li>
                                        <li><a href="#" class="dropdown-item" data-bs-toggle="modal"
                                                data-bs-target="#mute-notification"><i
                                                    class="ti ti-bell-off me-2"></i>{{ __('Mute Notification')}}</a></li>
                                        <li><a href="#" class="dropdown-item" data-bs-toggle="modal"
                                                data-bs-target="#msg-disapper"><i
                                                    class="ti ti-clock me-2"></i>{{ __('Disappearing Message')}}</a></li>
                                        <li><a href="#" class="dropdown-item" data-bs-toggle="modal"
                                                data-bs-target="#clear-group-chat"><i
                                                    class="ti ti-clear-all me-2"></i>{{ __('Clear Message')}}</a></li>
                                        <li><a href="#" class="dropdown-item" data-bs-toggle="modal"
                                                data-bs-target="#delete-group"><i
                                                    class="ti ti-trash me-2"></i>{{ __('Delete Group')}}</a></li>
                                        <li><a href="#" class="dropdown-item" data-bs-toggle="modal"
                                                data-bs-target="#report-group"><i
                                                    class="ti ti-flag me-2"></i>{{ __('Report')}}</a></li>
                                        <li><a href="#" class="dropdown-item" data-bs-toggle="modal"
                    ...
                    <form class="footer-form" id="message-form">
                        ...
                        <div class="chat-footer-wrap d-inline">
                            ...
                            <div class="chat-footer-content d-flex align-items-center">
                                <div class="form-item">
                                    <a href="#" class="action-circle" data-bs-toggle="modal"
                                        data-bs-target="#record_audio"><i class="ti ti-microphone"></i></a>
                                </div>
                                <div class="form-wrap">
                                ...
                                @if($callsProvider === 'meet')
                                    <div class="form-item emoj-action-foot">
                                        <a href="javascript:void(0);" id="send-meet-link-btn" class="action-circle"
                                ...
                                <div class="form-item dropdown">
                                    <a href="javascript:void(0);" class="action-circle" data-bs-toggle="dropdown"
                                        aria-expanded="false" title="{{ __('Attachments') }}">
                                        <i class="ti ti-plus"></i>
                                    </a>
                                    <ul class="dropdown-menu dropdown-menu-end p-2">
                                        <li><a class="dropdown-item" href="javascript:void(0);" id="attach-camera"><i
                                                    class="ti ti-camera me-2"></i>{{ __('Camera') }}</a></li>
                                        <li><a class="dropdown-item" href="javascript:void(0);" id="attach-gallery"><i
                                                    class="ti ti-photo me-2"></i>{{ __('Gallery') }}</a></li>
                                        <li><a class="dropdown-item" href="javascript:void(0);" id="attach-audio"><i
                                                    class="ti ti-music me-2"></i>{{ __('Audio') }}</a></li>
                                        <li><a class="dropdown-item" href="javascript:void(0);" id="attach-file"><i
                                                    class="ti ti-file me-2"></i>{{ __('File') }}</a></li>
                                    </ul>
                                    <input type="file" class="d-none" name="files" id="files">
                                    <input type="file" class="d-none" id="files-camera" accept="image/*"
                                        capture="environment">
                                </div>
                                <div>
            ...
            <!-- Group Info -->
            <div class="chat-offcanvas offcanvas offcanvas-end contact-profile-offcanvas" data-bs-scroll="true"
                data-bs-backdrop="false" tabindex="-1" id="contact-profile">
                    ...
                    <div class="chat-contact-info contact-info-sidebar">
                        <div class="profile-content px-3 pb-3">
                            ...
                            <div class="contact-action-grid mb-4">
                                <a href="javascript:void(0);" class="contact-action-tile" id="group-profile-audio-btn"
                                    title="{{ __('Audio') }}">
                                    <i class="ti ti-phone"></i>
                                    <span>{{ __('Audio') }}</span>
                                </a>
                                <a href="javascript:void(0);" class="contact-action-tile" id="group-profile-video-btn"
                                    title="{{ __('Video') }}">
                                    <i class="ti ti-video"></i>
                                    <span>{{ __('Video') }}</span>
                                </a>
                                <a href="javascript:void(0);" class="contact-action-tile" id="group-profile-chat-btn"
                                    title="{{ __('Chat') }}">
                                    <i class="ti ti-message"></i>
                                    <span>{{ __('Chat') }}</span>
                                </a>
                                <a href="javascript:void(0);" class="contact-action-tile" id="group-profile-search-btn"
                                    title="{{ __('Search') }}">
                                    <i class="ti ti-search"></i>
                                    <span>{{ __('Search') }}</span>
                                </a>
                            ...
                            <div class="content-wrapper mb-3">
                                ...
                                <div class="card contact-info-card border-0">
                                    <div class="card-body py-3">
                                        <div
                                            class="social-icon d-flex align-items-center flex-wrap gap-3 justify-content-start">
                                            <a id="facebook-link" href="javascript:void(0);" class="contact-social-link"
                                                aria-label="Facebook"><i class="ti ti-brand-facebook"></i></a>
                                            <a id="twitter-link" href="javascript:void(0);" class="contact-social-link"
                                                aria-label="Twitter"><i class="ti ti-brand-twitter"></i></a>
                                            <a id="instagram-link" href="javascript:void(0);" class="contact-social-link"
                                                aria-label="Instagram"><i class="ti ti-brand-instagram"></i></a>
                                            <a id="linkedin-link" href="javascript:void(0);" class="contact-social-link"
                                                aria-label="LinkedIn"><i class="ti ti-brand-linkedin"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card contact-info-card border-0">
                                    <div class="card-body list-group list-group-flush profile-item p-0">
                                        ...
                                        <a href="javascript:void(0);"
                                            class="list-group-item list-group-item-action border-0 px-0 py-3 d-flex align-items-center justify-content-between group-media-row"
                                            data-media-target="group-media-collapse-photos">
                                            <div class="d-flex align-items-center gap-2"><i
                                                    class="ti ti-photo text-primary"></i><span>{{ __('Photos') }}</span>
                                            </div>
                                            <span class="link-icon media-chevron"><i class="ti ti-chevron-right"></i></span>
                                        </a>
                                        <div class="collapse" id="group-media-collapse-photos">
                                            <div class="pb-2">
                                                <div class="media-loading text-center py-2 d-none">
                                                    <div class="spinner-border spinner-border-sm text-primary"
                                                        role="status"></div>
                                                </div>
                                                <div class="media-empty text-muted small text-center py-2 d-none">
                                                    {{ __('No photos found.') }}</div>
                                        ...
                                        <a href="javascript:void(0);"
                                            class="list-group-item list-group-item-action border-0 px-0 py-3 d-flex align-items-center justify-content-between group-media-row"
                                            data-media-target="group-media-collapse-videos">
                                            <div class="d-flex align-items-center gap-2"><i
                                                    class="ti ti-video text-primary"></i><span>{{ __('Videos') }}</span>
                                            </div>
                                            <span class="link-icon media-chevron"><i class="ti ti-chevron-right"></i></span>
                                        </a>
                                        ...
                                        <a href="javascript:void(0);"
                                            class="list-group-item list-group-item-action border-0 px-0 py-3 d-flex align-items-center justify-content-between group-media-row"
                                            data-media-target="group-media-collapse-links">
                                            <div class="d-flex align-items-center gap-2"><i
                                                    class="ti ti-link text-primary"></i><span>{{ __('Links') }}</span></div>
                                            <span class="link-icon media-chevron"><i class="ti ti-chevron-right"></i></span>
                                        </a>
                                        ...
                                        <a href="javascript:void(0);"
                                            class="list-group-item list-group-item-action border-0 px-0 py-3 d-flex align-items-center justify-content-between group-media-row"
                                            data-media-target="group-media-collapse-docs">
                                            <div class="d-flex align-items-center gap-2"><i
                                                    class="ti ti-file-text text-primary"></i><span>{{ __('Documents') }}</span>
                                            </div>
                                            <span class="link-icon media-chevron"><i class="ti ti-chevron-right"></i></span>
                                        </a>
                            ...
                            <div class="content-wrapper other-info mb-3">
                                ...
                                <div class="card contact-info-card border-0 mb-0">
                                    <div class="card-body list-group profile-item p-0">
                                        ...
                                        {{-- Favorites --}}
                                        <a href="javascript:void(0);"
                                            class="list-group-item list-group-item-action border-0 px-0 py-3 d-flex align-items-center justify-content-between group-others-row"
                                            id="group-open-favourites">
                                            <div class="d-flex align-items-center gap-2">
                                                <i class="ti ti-bookmark text-primary"></i>
                                                <span class="fw-medium">{{ __('Favorites') }}</span>
                                                <span class="badge bg-danger rounded-pill ms-1 d-none"
                                                    id="group-favourites-badge">0</span>
                                            </div>
                                            <span class="link-icon group-fav-chevron"><i
                                                    class="ti ti-chevron-right"></i></span>
                                        </a>
                                        <div class="collapse border-top border-light" id="group-collapse-favourites">
                                            <div class="py-2">
                                                <div class="others-loading text-center py-2 d-none">
                                                    <div class="spinner-border spinner-border-sm text-primary"
                                                        role="status"></div>
                                                </div>
                                                <div class="others-empty text-muted small text-center py-2 d-none">
                                                    {{ __('No saved messages in this group.') }}</div>
                            ...
                            <div class="content-wrapper other-info mb-3">
                                <div class="card contact-info-card border-0 mb-0">
                                    <div class="card-body list-group profile-item p-0">
                                        <a href="javascript:void(0);"
                                            class="list-group-item list-group-item-action border-0 px-0 py-3 d-flex align-items-center justify-content-between"
                                            data-bs-toggle="modal" data-bs-target="#group-encryption-info">
                                            <div class="d-flex align-items-center gap-2">
                                    ...
                                    <div class="card-body list-group profile-item p-0">
                                        <a href="javascript:void(0);"
                                            ...
                                            <div class="profile-info flex-grow-1 pe-2">
                                                ...
                                                <p class="text-muted small mb-0" id="group-setting-edit-label">
                                                    {{ __('All Participants') }}</p>
                                            </div>
                                            <span class="link-icon"><i class="ti ti-chevron-right"></i></span>
                                        </a>

                                        <div class="accordion accordion-flush chat-accordion list-group-item border-0 px-0 py-2"
                                            id="send-settings-group-info">
                                            <div class="accordion-item w-100 border-0">
                                                <h2 class="accordion-header">
                                                    <button type="button"
                                                        class="accordion-button py-2 collapsed shadow-none bg-transparent"
                                                        data-bs-toggle="collapse" data-bs-target="#send-privacy-group-info"
                                                        aria-expanded="false" aria-controls="send-privacy-group-info">
                                                        {{ __('Send Messages') }}
                                                    </button>
                                                </h2>
                                                <p class="fs-14 text-muted mb-0 ps-3" id="group-setting-send-label">
                                                    {{ __('All Participants') }}</p>
                                                <div id="send-privacy-group-info" class="accordion-collapse collapse"
                                                    data-bs-parent="#send-settings-group-info">
                                                    <div class="accordion-body px-3 pt-2 pb-3">
                                                        <div class="form-check mb-3">
                                                            <input class="form-check-input" type="radio"
                                                                name="group_send_messages" id="group-send-all" checked>
                                                            <label class="form-check-label"
                                                                for="group-send-all">{{ __('All Participants') }}</label>
                                                        </div>
                                                        <div class="form-check mb-3">
                                                            <input class="form-check-input" type="radio"
                                                                name="group_send_messages" id="group-send-admins-only">
                                                            <label class="form-check-label"
                                                                for="group-send-admins-only">{{ __('Only Admins') }}</label>
                                                        </div>
                                                        <button type="button" class="btn btn-primary w-100"
                                                            id="group-send-messages-save-btn">{{ __('Save Changes') }}</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <a href="javascript:void(0);"
                                            class="list-group-item list-group-item-action border-0 px-0 py-3 d-flex align-items-center justify-content-between"
                                            data-bs-toggle="modal" data-bs-target="#approve-participants">
                                            <div class="profile-info flex-grow-1 pe-2">
                                                <h6 class="fs-16 mb-1">{{ __('Approve New Participants') }}</h6>
                                                <p class="text-muted small mb-0" id="group-setting-approve-label">
                                                    {{ __('Off') }}</p>
                                            </div>
                                            <span class="link-icon"><i class="ti ti-chevron-right"></i></span>
                                        </a>
                                        <a href="javascript:void(0);"
                                            class="list-group-item list-group-item-action border-0 px-0 py-3 d-flex align-items-center justify-content-between"
                                            data-bs-toggle="modal" data-bs-target="#edit-admin">
                                            <div class="profile-info flex-grow-1 pe-2">
                                        ...
                                        <a href="javascript:void(0);"
                                            class="list-group-item list-group-item-action border-0 px-0 py-3 d-flex align-items-center justify-content-between"
                                            data-bs-toggle="modal" data-bs-target="#mute-notification">
                                            <div class="profile-info flex-grow-1 pe-2">
                                                <h6 class="fs-16 mb-1"><i
                                                        class="ti ti-bell-off me-2 text-warning"></i>{{ __('Mute Notifications') }}
                                                </h6>
                                        ...
                                        <a href="javascript:void(0);"
                                            class="list-group-item list-group-item-action border-0 px-0 py-3 d-flex align-items-center justify-content-between"
                                            data-bs-toggle="modal" data-bs-target="#msg-disapper">
                                            <div class="profile-info flex-grow-1 pe-2">
                                                <h6 class="fs-16 mb-1"><i
                                                        class="ti ti-clock me-2 text-info"></i>{{ __('Disappearing Messages') }}
                                                </h6>
                                                <p class="text-muted small mb-0">
                                                    {{ __('Timer for new messages in this group') }}</p>
                                            </div>
                                            <span class="link-icon"><i class="ti ti-chevron-right"></i></span>
                                        </a>
                                    </div>
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-2">
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        <a href="javascript:void(0);" class="text-muted"
                                            id="group-participants-search-toggle"><i class="ti ti-search"></i></a>
                                        <a href="javascript:void(0);" class="text-muted" data-bs-toggle="modal"
                                            data-bs-target="#group-add-new" title="{{ __('Add Members') }}"><i
                                                class="ti ti-user-plus"></i></a>
                                    </div>
                                </div>
                                <div class="mb-2 d-none" id="group-participants-search-wrap">
                                    <input type="text" class="form-control form-control-sm" id="group-participants-search"
                                ...
                                <div class="card contact-info-card border-0">
                                    <div class="card-body p-0">
                                        ...
                                        <div class="text-center py-2 d-none" id="group-view-all-members">
                                            <a href="javascript:void(0);" class="small fw-medium text-primary"
                                                id="group-view-all-link">
                        ...
                        <div class="content-wrapper other-info mb-0 px-3 pb-3">
                            <div class="card contact-info-card border-0 mb-0">
                                <div class="card-body list-group profile-item p-0">
                                    <a href="javascript:void(0);"
                                        class="list-group-item list-group-item-action border-0 px-0 py-3 d-flex align-items-center justify-content-between"
                                        data-bs-toggle="modal" data-bs-target="#group-logout">
                                        <div class="d-flex align-items-center gap-2">
                                    ...
                                    <a href="javascript:void(0);"
                                        class="list-group-item list-group-item-action border-0 px-0 py-3 d-flex align-items-center justify-content-between"
                                        data-bs-toggle="modal" data-bs-target="#report-group">
                                        <div class="d-flex align-items-center gap-2">
                    ...
                    <div class="modal-body">
                        <form onsubmit="return false">
                            <div class="block-wrap text-center mb-3">
                                ...
                                <p class="text-grya-9">
                                    {{ __('Blocking this group will remove you from the group. You will no longer receive messages from this group.')}}
                                </p>
                            </div>
                            <div class="row g-3">
                                <div class="col-6">
                        ...
                        <form action="{{ route('chat')}}">
                            <div class="block-wrap mb-3">
                                <p class="text-grya-9 mb-3">
                                    {{ __('We will report this user for review when you tap Report below.') }}</p>
                ...
                <div class="modal-content">
                            ...
                            <div class="card-body d-flex justify-content-center">
                                <div>
                                    <div class="d-flex justify-content-center avatar-group mb-2">
                                        ...
                                        <a href="#"
                                            class="d-inline-flex align-items-center justify-content-center rounded-circle bg-soft-primary"
                    ...
                    <div class="modal-footer justify-content-center border-0">
                        <a href=""
                            ...
                            data-bs-toggle="modal" data-bs-target="#voice_attend"><span>
                                <i class="ti ti-phone fs-20"></i>
                            </span></a>
                        <a href="javascript:void(0);" data-bs-dismiss="modal"
                            class="voice-icon btn btn-danger rounded-circle d-flex justify-content-center align-items-center"><span>
    ...
    <div id="group-context-menu" class="dropdown-menu p-2 shadow" style="display:none;position:fixed;z-index:9999;">
        <a href="#" class="dropdown-item" data-ctx-action="archive"><i
                class="ti ti-archive me-2"></i>{{ __('Archive Group') }}</a>
        <a href="#" class="dropdown-item" data-ctx-action="mute"><i
                class="ti ti-bell-off me-2"></i>{{ __('Mute Notification') }}</a>
        <a href="#" class="dropdown-item" data-ctx-action="exit"><i
                class="ti ti-logout-2 me-2"></i>{{ __('Exit Group') }}</a>
        <a href="#" class="dropdown-item" data-ctx-action="pin"><i class="ti ti-pin me-2"></i>{{ __('Pin Group') }}</a>
        <a href="#" class="dropdown-item" data-ctx-action="unread"><i
                class="ti ti-mail me-2"></i>{{ __('Mark as Unread') }}</a>
    </div>

    <!-- /Content -->

    <div id="spa-page-modals">
        {{-- Modals must live here (not inside #spa-page-content): nested stacking + docked Group Info offcanvas caused
        double black backdrops. --}}
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="approve-participants-form" onsubmit="return false">
                            ...
                            <div class="mb-3">
                                <div class="form-check mb-3">
                                    <input class="form-check-input" type="radio" name="group_approve_join" id="approve1"
                                        checked>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-6">
                                    <button type="submit" class="btn btn-primary w-100"
                                        id="approve-participants-save-btn">Save</button>
                                </div>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="modal-body">
                        <form id="edit-group-settings-form" onsubmit="return false">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-6">
                                    <button type="submit" class="btn btn-primary w-100"
                                        id="edit-group-settings-save-btn">Save</button>
                                </div>
                            </div>
                        </form>
                    </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="edit-admin-form" action="{{ route('group-chat')}}" onsubmit="return false">
                            <div class="search-wrap contact-search mb-3">
                                <div class="input-group">
                                    <input type="text" id="edit-admin-search" class="form-control"
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-6">
                                    <button type="submit" class="btn btn-primary w-100"
                                        id="edit-admin-save-btn">{{ __('Save') }}</button>
                                </div>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="modal-body">
                        <form onsubmit="return false">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-6">
                                    <button type="button" class="btn btn-primary w-100"
                                        id="confirm-exit">{{ __('Exit Group') }}</button>
                                </div>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="modal-body">
                        <form>
                            <div class="block-wrap text-center mb-3">
                                ...
                                <p class="text-grya-9">{{ __('This will permanently delete all messages from this chat.')}}
                                </p>
                            </div>
                            <div class="row g-3">
                                <div class="col-6">
                                ...
                                <div class="col-6">
                                    <button type="button" class="btn btn-primary w-100"
                                        id="clear-group-btn">{{ __('Delete')}}</button>
                                </div>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="modal-body">
                        <form>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-6">
                                    <button type="button" class="btn btn-primary w-100"
                                        id="deleteGroupBtn">{{ __('Delete')}}</button>
                                </div>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="modal-body">
                        <form id="group-mute-notification-form" onsubmit="return false">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-6">
                                    <button type="button" class="btn btn-primary w-100"
                                        id="group-mute-save-btn">{{ __('Mute')}}</button>
                                </div>
                            </div>
                        </form>
                    </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p class="text-muted mb-0">
                            {{ __('Group text messages are encrypted before they are stored. Media and metadata may still be visible to your server or storage provider depending on your setup.') }}
                        </p>
                    </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="group-msg-disappear-form" onsubmit="return false">
                            <div class="block-wrap mb-3">
                                <p class="text-gray-9">
                                    For more privacy and storage, all new messages will disappear from this chat for
                                    everyone after the selected duration, except when kept. Anyone in the chat can change
                                    this setting.
                                </p>
                            </div>
                            <div class="mb-3">
                                <div class="form-check mb-3">
                                    <input class="form-check-input" type="radio" name="group_disappear" id="disappear1"
                                        value="86400000">
                                    <label class="form-check-label" for="disappear1">24 Hours</label>
                                </div>
                                <div class="form-check mb-3">
                                    <input class="form-check-input" type="radio" name="group_disappear" id="disappear2"
                                        value="604800000">
                                    <label class="form-check-label" for="disappear2">7 Days</label>
                                </div>
                                <div class="form-check mb-3">
                                    <input class="form-check-input" type="radio" name="group_disappear" id="disappear3"
                                        value="7776000000">
                                    <label class="form-check-label" for="disappear3">90 Days</label>
                                </div>
                                <div class="form-check mb-3">
                                    <input class="form-check-input" type="radio" name="group_disappear" id="disappear4"
                                        value="0" checked>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-6">
                                    <button type="button" class="btn btn-primary w-100"
                                        id="group-disappear-save-btn">Save</button>
                                </div>
                            </div>
                        </form>
                    </div>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <button type="button" class="btn-close" id="group-add-cancle-btn" data-bs-dismiss="modal"
                            aria-label="Close">
                            <i class="ti ti-x"></i>
                        </button>
                    </div>
                        ...
                        <form id="group-form">
                            <div class="d-flex justify-content-center align-items-center">
                                <label for="avatar-upload" class="set-pro avatar avatar-xxl rounded-circle mb-3 p-1">
                                    <img id="avatar-preview" src="" data-default-avatar="" class="rounded-circle"
                                        alt="user">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="input-icon mb-3 position-relative">
                                        <input type="text" id="group-names" class="form-control"
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="input-icon mb-3 position-relative">
                                        <input type="text" id="group-about" class="form-control"
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="d-flex align-items-center gap-4 mb-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="group-type"
                                                id="group-type-public" value="public" checked>
                                            <label class="form-check-label"
                                                for="group-type-public">{{ __('Public')}}</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="group-type"
                                                id="group-type-private" value="private">
                                            <label class="form-check-label"
                                                for="group-type-private">{{ __('Private')}}</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row g-3">
                                <div class="col-6">
                                    <a href="#" class="btn btn-outline-primary w-100" id="cancle-btn-group"
                                        data-bs-dismiss="modal" aria-label="Close">{{ __('Cancel')}}</a>
                                </div>
                                <div class="col-6">
                                    <button type="button" class="btn btn-primary w-100" data-bs-toggle="modal"
                                        data-bs-target="#add-group">{{ __('Next')}}</button>
                                </div>
                            </div>
                        </form>
                    </div>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <button type="button" class="btn-close" id="canlce-btn-search" data-bs-dismiss="modal"
                            aria-label="Close">
                            <i class="ti ti-x"></i>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form onsubmit="return false" id="add-members-form">
                            <div class="search-wrap contact-search mb-3">
                                <div class="input-group">
                                    <input type="text" id="groupcontactSearchInput" class="form-control"
                                        placeholder="{{ __('Search')}}">
                                    <a href="javascript:void(0);" class="input-group-text"><i class="ti ti-search"></i></a>
                                </div>
                            </div>
                            ...
                            <div id="noGroupMatchesModalMessage" style="display: none;">{{ __('No matches found.')}}</div>
                            <!-- User list will be displayed here -->
                            <div class="row g-3">
                                <div class="col-6">
                                    <a href="#" class="btn btn-outline-primary w-100" data-bs-toggle="modal"
                                        data-bs-target="#new-group">{{ __('Previous')}}</a>
                                </div>
                                <div class="col-6">
                                    <button type="button" class="btn btn-primary w-100"
                                        id="start-group">{{ __('Start Group')}}</button>
                                </div>
                            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-6">
                                <button type="button" class="btn btn-primary w-100"
                                    id="select-add-group">{{ __('Add') }}</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-6">
                                <button type="button" class="btn btn-primary w-100"
                                    id="save-edit-msg-btn">{{ __('Save') }}</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="delete-chat-form">
                            ...
                            <div class="form-check mb-3">
                                <input class="form-check-input" type="radio" value="for-me" name="delete-chat"
                                    id="delete-for-me" checked>
                                <label class="form-check-label" for="delete-for-me">Delete For Me</label>
                            </div>
                            <div class="form-check mb-3" id="delete-for-everyone-group">
                                <input class="form-check-input" type="radio" value="for-everyone" name="delete-chat"
        ...
        {{-- Voice message recording: same UI/flow as 1:1 chat (firebaseChat.js). Group audio/video call modals live in
        frontend.partials.popups. --}}
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <div class="center-align">
                                <p id="voice-record-timer" class="text-center mb-2 fw-semibold text-muted"
                                    aria-live="polite">0:00</p>
                                <audio controls id="audio" preload="metadata"></audio>
                                <br>
                                <button type="button" class="btn btn-warning btn-sm"
                                    id="startRecording">{{ __('Start') }}</button>
                                <button type="button" class="btn btn-dark btn-sm" id="stopRecording"
                                    disabled>{{ __('Stop') }}</button>
                                <button type="button" class="btn btn-info btn-sm" id="send_voice"
