                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12">
						<div class="row justify-content-center align-items-center vh-100 overflow-auto flex-wrap login-bg1 ">
							<div class="col-md-9 mx-auto p-4">
								<form id="reset-password-form-new">
									<div>
										<div class=" mx-auto mb-5 text-center">
											<img id="company-logo" src="assets/img/full-logo.png"
												class="img-fluid" alt="Logo">
										</div>
										<div class="card">
											<div class="card-body">
												<div class=" mb-4">
													<h2 class="mb-2">{{ __('Set New Password')}}</h2>
												</div>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <div class="input-icon ">
                                                                <input type="password" id="new-password" class="pass-input form-control validate-input">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <div class="input-icon ">
                                                                <input type="password" id="confirm-password" class="pass-inputs form-control validate-input">
												...
												<button type="submit" class="btn btn-primary w-100 justify-content-center">{{ __('Set New Password')}}</button>
								...
								<div class="mt-5 text-center">
									<p class="mb-0 text-gray-9"> <i class="ti ti-circle-arrow-left"></i> {{ __('Back to')}} <a href="{{ route('signin')}}" class="link-primary">{{ __('Sign In')}}</a></p>
								</div>
							</div>
