                            ...
                            <div class="card border">
                                ...
                                <div class="card-body pb-1">
                                    <div class="row align-items-center">
                                        <div class="col-md-4">
                                            <label class="form-label text-default fw-normal mb-3" >{{ __('Facebook')}}</label>
                                        </div>
                                        <div class="col-md-8">
                                        ...
                                        <div class="col-md-4">
                                            <label class="form-label text-default fw-normal mb-3" >{{ __('Twitter')}}</label>
                                        </div>
                                        <div class="col-md-8">
                                            <div class="input-icon position-relative mb-3">
                                        ...
                                        <div class="col-md-4">
                                            <label class="form-labe text-default fw-normall mb-3" >{{ __('Instagram')}}</label>
                                        </div>
                                        <div class="col-md-8">
                                            <div class="input-icon position-relative mb-3">
                                        ...
                                        <div class="col-md-4">
                                            <label class="form-label text-default fw-normal mb-3" >{{ __('LinkedIn')}}</label>
                                        </div>
                                        <div class="col-md-8">
                                            <div class="input-icon position-relative mb-3">
                                        ...
                                        <div class="col-md-4">
                                            <label class="form-label text-default fw-normal mb-3" >{{ __('YouTube')}}</label>
                                        </div>
                                        <div class="col-md-8">
                                            <div class="input-icon position-relative mb-3">
                                        ...
                                        <div class="col-md-4">
                                            <label class="form-label text-default fw-normal mb-3" >{{ __('Kick')}}</label>
                                        </div>
                                        <div class="col-md-8">
                                            <div class="input-icon position-relative mb-3">
                                                <input type="text" class="form-control" id="kick_link">
                                                <span class="input-icon-addon">
                                        ...
                                        <div class="col-md-4">
                                            <label class="form-label text-default fw-normal mb-3" >{{ __('Twitch')}}</label>
                                        </div>
                                        <div class="col-md-8">
                                            <div class="input-icon position-relative mb-3">
                                                <input type="text" class="form-control" id="twitch_link">
                                                <span class="input-icon-addon">
                            ...
                            <div class="card border">
                                ...
                                <div class="card-body pb-1">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-md-4">
                                            <label class="form-label text-default fw-normal mb-3" >{{ __('Instagram')}}</label>
                                        </div>
                                        <div class="col-md-8">
                                            <div class="input-icon position-relative mb-3">
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-icon position-relative mb-3">
                                                <input type="text" id="edit-kick" class="form-control">
                                                <span class="input-icon-addon">
                                                    <i class="ti ti-device-gamepad-2"></i>
                                                </span>
                                            </div>
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-icon position-relative mb-3">
                                                <input type="text" id="edit-twitch" class="form-control">
                                                <span class="input-icon-addon">
                                                    <i class="ti ti-brand-twitch"></i>
                                                </span>
                                            </div>
                ...
                <div class="d-flex align-items-center">
                    <div class="dropdown me-2">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end p-3">
                            <li><a class="dropdown-item" href="#" ><i class="ti ti-share-3 me-2"></i>{{ __('Share')}}</a>
                            </li>
                            ...
                            <li><a class="dropdown-item" href="#" data-bs-toggle="modal"
                                    data-bs-target="#block-user" ><i class="ti ti-ban me-2"></i>{{ __('Block')}}</a></li>
                            <li><a class="dropdown-item" href="#" ><i class="ti ti-trash me-2"></i>{{ __('Delete')}}</a>
                            </li>
                        </ul>
                    </div>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                ...
                <div class="card border mb-3">
                    ...
                    <div class="card-body pb-1">
                        <div class="mb-2">
                            <div class="row align-items-center">
                                <div class="col-sm-6">
                                    <p class="mb-2 d-flex align-items-center" ><i class="ti ti-calendar-event me-1"></i>{{ __('Date of Birth')}}</p>
                                </div>
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    <p class="mb-2 d-flex align-items-center" ><i class="ti ti-globe me-1"></i>{{ __('Website Address')}}</p>
                                </div>
                                <div class="col-sm-6">
                ...
                <div class="card border mb-0">
                    ...
                    <div class="card-body pb-1">
                        <div class="mb-2">
                            <div class="row align-items-center">
                                <div class="col-sm-6">
                                    <p class="mb-2 d-flex align-items-center" ><i class="ti ti-brand-facebook me-1"></i>{{ __('Facebook')}}</p>
                                </div>
                                <div class="col-sm-6">
                                    <h6 class="fw-medium fs-14 mb-2" data-field="facebook"></h6>
                                </div>
                                <div class="col-sm-6">
                                    <p class="mb-2 d-flex align-items-center" ><i class="ti ti-brand-twitter me-1"></i>{{ __('Twitter')}}</p>
                                </div>
                                <div class="col-sm-6">
                                    <h6 class="fw-medium fs-14 mb-2" data-field="twitter"></h6>
                                </div>
                                <div class="col-sm-6">
                                    <p class="mb-2 d-flex align-items-center" ><i class="ti ti-brand-instagram me-1"></i>{{ __('Instagram')}}</p>
                                </div>
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    <p class="mb-2 d-flex align-items-center" ><i class="ti ti-brand-youtube me-1"></i>{{ __('YouTube')}}</p>
                                </div>
                                <div class="col-sm-6">
                                    <h6 class="fw-medium fs-14 mb-2" data-field="youtube"></h6>
                                </div>
                                <div class="col-sm-6">
                                    <p class="mb-2 d-flex align-items-center" ><i class="ti ti-device-gamepad-2 me-1"></i>{{ __('Kick')}}</p>
                                </div>
                                <div class="col-sm-6">
                                    <h6 class="fw-medium fs-14 mb-2" data-field="kick"></h6>
                                </div>
                                <div class="col-sm-6">
                                    <p class="mb-2 d-flex align-items-center" ><i class="ti ti-brand-twitch me-1"></i>{{ __('Twitch')}}</p>
                                </div>
                                <div class="col-sm-6">
