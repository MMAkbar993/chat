                                    ...
                                    <tbody>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar avatar-sm me-2 avatar-rounded">
                                                        <img src="{{ asset('assets/img/profiles/profile-01.jpg') }}" alt="img">
                                                    </div>
                                                    <div>
                                                        <div class="lh-1">
                                            ...
                                            <td>
                                                <div class="avatar-list-stacked">
                                                    <span class="avatar avatar-sm avatar-rounded">
                                                        <img src="{{ asset('assets/img/profiles/profile-02.jpg') }}" alt="img">
                                                    </span>
                                                    <span class="avatar avatar-sm avatar-rounded">
                                                        <img src="{{ asset('assets/img/profiles/profile-08.jpg') }}" alt="img">
                                                    </span>
                                                    <span class="avatar avatar-sm avatar-rounded">
                                                        <img src="{{ asset('assets/img/profiles/profile-02.jpg') }}" alt="img">
                                                    </span>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar avatar-sm me-2 avatar-rounded">
                                                        <img src="{{ asset('assets/img/profiles/profile-03.jpg') }}" alt="img">
                                                    </div>
                                                    <div>
                                                        <div class="lh-1">
                                                            <span>Kara Kova</span>
                                            ...
                                            <td>
                                                <div class="avatar-list-stacked">
                                                    <span class="avatar avatar-sm avatar-rounded">
                                                        <img src="{{ asset('assets/img/profiles/profile-04.jpg') }}" alt="img">
                                                    </span>
                                                    <span class="avatar avatar-sm avatar-rounded">
                                                        <img src="{{ asset('assets/img/profiles/profile-06.jpg') }}" alt="img">
                                                    </span>
                                                    <a class="avatar avatar-sm bg-primary text-fixed-white avatar-rounded"
                                                        href="javascript:void(0);">
                                                        +6
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="avatar-list-stacked">
                                                    ...
                                                    <span class="avatar avatar-sm avatar-rounded">
                                                        <img src="{{ asset('assets/img/profiles/profile-10.jpg') }}" alt="img">
                                                    </span>
                                                    <span class="avatar avatar-sm avatar-rounded">
                                                        <img src="{{ asset('assets/img/profiles/profile-09.jpg') }}" alt="img">
                                                    </span>
                                                    <a class="avatar avatar-sm bg-primary text-fixed-white avatar-rounded"
                                                        href="javascript:void(0);">
                                                        +2
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar avatar-sm me-2 avatar-rounded">
                                                        <img src="{{ asset('assets/img/profiles/profile-07.jpg') }}" alt="img">
                                                    </div>
                                                    <div>
                                                        <div class="lh-1">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="avatar-list-stacked">
                                                    ...
                                                    <span class="avatar avatar-sm avatar-rounded">
                                                        <img src="{{ asset('assets/img/profiles/profile-05.jpg') }}" alt="img">
                                                    </span>
                                                    <span class="avatar avatar-sm avatar-rounded">
                                                        <img src="{{ asset('assets/img/profiles/profile-10.jpg') }}" alt="img">
                                                    </span>
