...
<head>
    ...
    <title>Dreamschat - Installer</title>
        ...
        <div class="row">
            <ul class="progressbars">
                <ul class="progressbar">
                    ...
                    <li class="@if (request()->routeIs('setup.database') || (session()->has('step-3-complete') && session()->get('step-3-complete'))) active @endif"><a href="@if ((session()->has('step-2-complete') && session()->get('step-2-complete') && session()->has('requirements-complete') && session()->get('requirements-complete'))) {{route('setup.database')}} @else # @endif" class="@if (!session()->has('requirements-complete')) text-muted @endif">Firebse Setup</a></li>
