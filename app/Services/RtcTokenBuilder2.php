...
namespace App\Services; // Add this line at the top

use Exception;
use App\Services\AccessToken2; // Correctly reference other classes
use App\Services\ServiceRtc;  // Add this if ServiceRtc is missing
