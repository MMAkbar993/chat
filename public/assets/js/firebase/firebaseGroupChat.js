...
initializeFirebase(function (app, auth, database, storage) {
    ...
    async function fetchGroupInfo(groupId) {
        ...
        if (countEl) {
            countEl.textContent = `Group - ${(groupData.userIds && groupData.userIds.length) || 0
                } Participants`;
        }
        ...
        try {
            ...
            membersDetails.forEach((user) => {
                ...
                <div class="form-check flex-shrink-0 ms-2">
                    <input class="form-check-input edit-admin-cb" type="checkbox" name="edit_admin_member" value="${user.memberId
