...
Template Name: Dreamschat - Bootstrap Template
Version      : 1.0
*/
...
(function ($) {
	...
	if($('.application-slider2').length > 0) {
		$('.application-slider2').owlCarousel({
			loop:true,
			margin:24,
			nav:false,
			dots:false,
	...
	if($('.application-slider3').length > 0) {
		$('.application-slider3').owlCarousel({
			loop:true,
			margin:24,
			nav:false,
			dots:false,
